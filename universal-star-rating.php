  ...
  global $ERR_MSG, $OUTPUT_MSG;
	...
	?>
		...
		<div class="wrap" style="width: 600px;">
          ...
          <td><?php _e($OUTPUT_MSG['ExampleUsrResult'][$usrLang], 'universal-star-rating'); ?></td>
          <tr>
          <tr>
          <td><?php _e($OUTPUT_MSG['ExampleUsrList'][$usrLang], 'universal-star-rating'); ?></td>
          <td><?php 
          if($usrLang == 'de'){echo insertUSRList(array("Pizza:7", "Eis:8.5", "Saure Milch"));}
          elseif($usrLang == 'en'){echo insertUSRList(array("Pizza:7", "Ice Cream:8.5", "Dirt"));}
           ?></td>
          <tr>
          </table>
          </p>
